...
(write('possibly_after_from([pa_2_fluent], [[pa_2_action,[pa_2_g1, pa_2_g2]]], [pa_2_cond]).'),
possibly_after_from([pa_2_fluent], [[pa_2_action,[pa_2_g1, pa_2_g2]]], [pa_2_cond]), passed; failed), nl,
